#ifndef _VTK_VIEW_WINDOW_H_
#define _VTK_VIEW_WINDOW_H_
...
// Main Window
class VTKViewWindow : public FXMainWindow
{
    FXDECLARE(VTKViewWindow)
...
public:
    ...
    // VTKViewWindow constructor
    VTKViewWindow(FXApp* a);

    // Initialize
    virtual void create();

    // VTKViewWindow destructor
    virtual ~VTKViewWindow();
};
